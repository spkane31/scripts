...
pwd = os.getcwd()
os.system("mkdir logs-notrace")
logsDir = os.path.join(pwd, "logs-notrace")
...
copy = "cp ../../models/%s/%s_sim ./logs-notrace/%s/%s_sim"
...
for i in iterations:
    ...
    size = i[2]
    runtime = i[3]
    os.chdir(os.path.join(os.getcwd(), "logs-notrace/")
